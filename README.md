...
| **Schema-Defined** | Data contract in `SCHEMA.md` defines the current project data shape |
...
# Access the project data directly through the local server routes
# http://localhost:8787/projects/my-archive/docs_logical.json
```
...
- [ ] Validation passes: `python3 skills/transcript/validate_docs.py projects/<name>`
...
**Core Documentation:**
- `README.md` (this file) — Overview, quick start, and current state
